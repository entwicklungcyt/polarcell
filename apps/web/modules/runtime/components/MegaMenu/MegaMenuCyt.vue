      ...
      <ul v-if="viewport.isGreaterOrEquals('lg')"
        ...
        <li v-for="(menuNode, index) in categoryTree" :key="index" class="relative group">
          ...
          <ul
            ...
            class="ddown hidden xl:group-hover:block absolute top-full left-0 right-0 bg-black/85 text-white z-50 shadow-lg border border-dotted border-white mt-[-1px] rounded-bl-[5px] rounded-br-[5px]
